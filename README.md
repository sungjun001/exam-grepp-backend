<h1 align="center"> Grepp Exam BackEnd API</h1>
...
** Grepp Exam BackEnd API ** creates an extendable async API using FastAPI, Pydantic V2, SQLAlchemy 2.0 and PostgreSQL:
...
Start by using the project, and naming the repository to what you want.
...
Then clone your created repository 
